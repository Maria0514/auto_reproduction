...
+----------------------------------------------------------+
|                 工具层 (core/tools/)                       |
|  deepxiv_tools | git_tools | pwc_tools | code_fs_tools   |
...
│       ├── pwc_tools.py          # Papers With Code API 搜索工具（search_pwc，本地节流）
...
| pwc_tools 封装 | `core/tools/pwc_tools.py` | Papers With Code API 搜索工具（search_pwc，本地节流） |
