...
> 　⇒ 🔴 **现行汇总账（2026-08-08；数字取自 §13 实算表，逐行加总非沿用）：检查点 `331` 个**（逐批 **25 / 45 / `150` / 83 / 16 / 12**）、**任务 40 个**（批次 2 = **15**）、**落点勘误 ~~`38`~~ ~~`41`~~ ~~`44`~~ ~~`47`~~ ~~`49`~~ ~~`50`~~ ~~`54`~~ ~~`59`~~ `62` 条**（`P-S8-1` ~ **`P-S8-62`**，其中**实质性 ~~`16`~~ ~~`17`~~ ~~`18`~~ ~~`20`~~ ~~`22`~~ ~~`26`~~ ~~`31`~~ `33` 条**；
🔴 **2026-08-10 ~ 08-11 批次 2 执行期新增 ~~6~~ ~~9~~ ~~11~~ ~~12~~ ~~16~~ ~~21~~ `24` 条 `P-S8-39 ~ ~~P-S8-44~~ `P-S8-62``，见 §15.0e** —— `39~41` 由 `T-S8-2-2` 实现前核实挖出、`42~44` 由 `T-S8-2-1` 真跑全量回归暴露、**`45~47` 由 `T-S8-2-1b` 实做时挖出**（`45` 收网抓出第四处 `<METRICS>`；`46` 是两条各自正确的约束互相拉扯；`47` 超范围登记不治））、**冻结表 10 行 → `5` 行**。~~（作废旧账：勘误 `35` 条）~~⚠ **上一行（`:6`，2026-08-07 那轮）记的 `329` / `148` / `20 条` / 「10→4」全部是当时的账、已被本轮作废** —— 保留作留痕，**不要照它对账**。
...
| **落点勘误** | ~~**`P-S8-1` ~ `P-S8-11`**~~ ~~**`P-S8-1` ~ `P-S8-20`**（共 **20** 条）~~ ~~**`P-S8-1` ~ `P-S8-25`**（共 **25** 条）~~ ~~**`P-S8-1` ~ `P-S8-34`**（共 **34** 条）~~ ~~**`P-S8-1` ~ `P-S8-35`**（共 **`35`** 条）~~ ~~⇒ **`P-S8-1` ~ `P-S8-38`**~~ ⇒ ~~**`P-S8-1` ~ `P-S8-54`**~~ ~~⇒ **`P-S8-1` ~ `P-S8-59`**~~ ⇒ **`P-S8-1` ~ `P-S8-62`**（🔴 **总数见文首「现行汇总账」权威行，本行 2026-08-09 起不复述**；构成：§15 本表 11 + §15.0 四条 + §15.0b 五条 + §15.0c 五条 + §15.0d 十三条 + ~~**§15.0e 六条**~~ ~~**§15.0e `16` 条**~~ ~~**§15.0e `21` 条**~~ **§15.0e `24` 条**⟦🔴 **2026-08-11 主控订正（`P-S8-54`）**：本处的「六条」**三轮推数（6→9→11→12）一次都没跟改**，而同一括号里的编号上界每轮都改了 ⇒ **同一个抄写口里的两个数独立老化**。加总现为 ~~11+4+5+5+13+16 = **54**~~ ~~**11+4+5+5+13+21 = `59`**~~ **11+4+5+5+13+24 = `62`**，与文首 `:10` 权威行一致⟧） | 本文 §15，**与 sprint7 的裸 `P-N`（已用到 P-73）显式分段** |
...
### 15.0e 🔴 批次 2 执行期新增勘误（~~**6 条**~~ ~~**9 条**~~ ~~**11 条**~~ ~~**12 条**~~ ~~**16 条**~~ ~~**21 条**~~ **`24` 条**：`P-S8-39 ~ ~~P-S8-44~~ `P-S8-62``，2026-08-10 ~ **08-11**，起点 `HEAD=ac60379`；**`P-S8-39~41` 由 `T-S8-2-2` 实现前核实挖出，`P-S8-42~44` 由 `T-S8-2-1` 落盘后真跑全量回归暴露，`P-S8-45~47` 由 `T-S8-2-1b` 实做时挖出**）

> **纪律**（沿 §15.0b / §15.0d 先例）：实做时凡与文档记载对不上、或按文档做会漏做/做错的，一律落进本表并写清磁盘实测值，**不默默按文档写的做**。
> 🔴 **本表 ~~3~~ ~~6~~ ~~9~~ ~~11~~ ~~12~~ ~~16~~ ~~21~~ `24` 条里有 ~~2~~ ~~3~~ ~~5~~ ~~10~~ `11` 条（`P-S8-39` / `P-S8-40` / **`P-S8-43`** / **`P-S8-51`** / **`P-S8-54`** / **`P-S8-55`** / **`P-S8-56`** / **`P-S8-57`** / **`P-S8-58`** / **`P-S8-59`** / **`P-S8-60`**）是同一份文档内部两处直接打架** —— 不是"文档与磁盘不符"，是"**文档与自己不符**"。⚠ **这类失真比对不上磁盘更危险**：执行者读到哪一处全凭运气，而两处都在同一份 dev-plan 里、都带着权威口吻。⇒ **`T-S8-2-2` 这类"实现前核实"任务的射程必须包含"同文档内互证"，不能只做"文档 vs 磁盘"。**
