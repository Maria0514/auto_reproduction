...
> **[转正记录 2026-07-06→07] Maria 授权"全跑"，6/6 全部由主控执行完毕**（详见
> `docs/sprint4/test-reports/2026-07-06_g2-real-run-conversion.md` 及其补记）。
> **本清单已清零，Sprint 4 无任何遗留验证项。**
...
| 2 | `real_s4_2`（真凭证注入 sandbox） | AC-S4-08 转正 | ✅ **PASS（2026-07-07 补跑，1.85s，零配额）**：真 PAT 经 GIT_ASKPASS 注入真实 clone 私有仓库成功，token 零明文；凭证残留（.secrets 条目/askpass 脚本）已清理，PAT 已提醒吊销 |
...
| AC-S4-08 | 凭证经 extra_env 注入 sandbox | CP-D1-2 / CP-E1-4 / CP-G2-3（Popen 层 spy 全链路 + 白名单收口首证） | ✅ mock 注入断言 + **真凭证真实 clone 转正（2026-07-07，真 PAT 私有仓库 exit 0 / token 零明文）** |
